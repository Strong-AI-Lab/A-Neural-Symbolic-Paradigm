...
def evaluate():
    ...
    for s in ['test_task_CWA0.csv', 'test_task_CWA1.csv', 'test_task_no_CWA0.csv', 'test_task_no_CWA1.csv']:
        ...
        results = list()
        dgen = LogicSeq.from_file("data/ConceptRulesV2/test/" + s, ARGS.batch_size, pad=ARGS.pad, verbose=False)
...
def plot_attention():
  ...
  ctxs = ["Water is not located in forest. Forest is located in earth. Earth is located in tree. Tree is located in surface of earth."]
